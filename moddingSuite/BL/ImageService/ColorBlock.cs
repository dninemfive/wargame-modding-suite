...
public class ColorBlock
{
    ...
    void boundsRange(Color32 start, Color32 end)
    {
        ...
        for (uint i = 0; i < 16; i++)
        {
            if (Data[i].r < minColor.r)
            { minColor.r = Data[i].r; }
            if (Data[i].g < minColor.g)
            { minColor.g = Data[i].g; }
            if (Data[i].b < minColor.b)
            { minColor.b = Data[i].b; }
            if (Data[i].r > maxColor.r)
            { maxColor.r = Data[i].r; }
            if (Data[i].g > maxColor.g)
            { maxColor.g = Data[i].g; }
            if (Data[i].b > maxColor.b)
            { maxColor.b = Data[i].b; }
        }
        ...
        Color32 inset = new()
        {
            r = (byte)((maxColor.r - minColor.r) >> 4),
            g = (byte)((maxColor.g - minColor.g) >> 4),
            b = (byte)((maxColor.b - minColor.b) >> 4)
        };
    ...
    void boundsRangeAlpha(Color32 start, Color32 end)
    {
        ...
        Color32 inset = new()
        {
            ...
            g = (byte)((maxColor.g - minColor.g) >> 4),
            b = (byte)((maxColor.b - minColor.b) >> 4),
            a = (byte)((maxColor.a - minColor.a) >> 4)
        };
