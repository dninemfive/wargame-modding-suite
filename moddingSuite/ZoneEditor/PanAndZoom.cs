...
internal class PanAndZoom
{
    ...
    public static MouseEventHandler MouseDown => new(OnMouseDown);
    public static MouseEventHandler MouseUp => new(OnMouseUp);
    public static MouseEventHandler MouseMove => new(OnMouseMove);
    public static MouseEventHandler MouseWheel => new(OnMouseWheel);
    ...
    private static void OnMouseUp(object sender, MouseEventArgs e) => mousepressed = false;
